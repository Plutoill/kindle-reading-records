...
4. 等待“阅读记录 v29 已安装”提示，然后从书库打开“阅读记录”。
...
- 新 UI 使用 handlerId com.krt.readingrecords.v29 和独立目录
  /mnt/us/reading-time/illusion/ReadingRecords-v29/，用于绕过旧 Mesquite/WAF 缓存。
...
成功日志应包含：
installed successfully; handler=com.krt.readingrecords.v29; UI=v29-daily-month-ranking;
